            ...
            <div class="container">
                <nav class="navbar navbar-expand-lg">
                    ...
                    <ul class="navbar-nav attr-nav align-items-center">
                        ...
                        @else
                    <a class="btn btn-fill-out rounded-0 staggered-animation text-uppercase animated slideInLeft" href="/create" data-animation="slideInLeft" data-animation-delay="1.5s" style="animation-delay: 1.5s; opacity: 1;">Signup</a>

                    <a class="btn btn-fill-out log rounded-0 staggered-animation text-uppercase animated slideInLeft" href="/login" data-animation="slideInLeft" data-animation-delay="1.5s" style="animation-delay: 1.5s; opacity: 1;">Login</a>
